...
- [ ] P11 — CI/CD & final documentation

Classical baseline results (Ridge/RandomForest/dummy floors — the measuring stick every later
deep model must beat) are in `docs/RESULTS.md`, generated by `pdm evaluate`. No metric numbers
are inlined into this README until P11's final documentation pass.
